...
2. **tau is not the same quantity in the two columns.** In M1 the random intercept is on
   ...
   `tau (Bayes)` is the posterior **median** of the study random-intercept SD
   (standardised 2026-08-14); `tau (REML)` is the REML point estimate.

|Outcome      |  k|Data        |Bayesian M1 OR [95% CrI] | tau (Bayes)|Frequentist REML OR [95% CI] | I2 (%)| tau (REML)|Concordance  |
|:------------|--:|:-----------|:------------------------|-----------:|:----------------------------|------:|----------:|:------------|
|c1_agvhd     | 28|post_block9 |0.67 [0.59-0.78]         |        0.67|0.61 [0.47-0.79]             |     62|       0.53|concordant   |
|c1_bk        | 11|post_block9 |2.48 [1.82-3.38]         |        1.00|2.36 [1.63-3.42]             |     17|       0.26|concordant   |
|c1_bsi       |  6|post_block9 |1.87 [1.33-2.62]         |        0.88|1.29 [0.61-2.73]             |     71|       0.75|CI crosses 1 |
...
|c1_cmv       | 22|post_block9 |1.26 [1.07-1.47]         |        0.73|1.25 [0.94-1.66]             |     62|       0.50|CI crosses 1 |
|c1_ifi_any   |  6|post_block9 |0.43 [0.29-0.63]         |        1.53|0.60 [0.21-1.74]             |     80|       1.11|CI crosses 1 |
|c1_irm       | 13|set_b       |1.19 [1.00-1.43]         |        0.82|1.03 [0.72-1.46]             |     57|       0.45|concordant   |
|c1_nrm       | 12|post_block9 |0.88 [0.66-1.18]         |        0.69|0.91 [0.68-1.23]             |      0|       0.00|concordant   |
...
|c2_bk        |  3|post_block9 |2.44 [1.40-4.26]         |        0.39|2.44 [1.41-4.22]             |      0|       0.00|concordant   |
...
|c2_rrm       | 10|post_block9 |0.79 [0.69-0.89]         |        0.14|0.78 [0.57-1.05]             |     57|       0.30|CI crosses 1 |
|c3_agvhd     |  7|post_block9 |1.00 [0.80-1.25]         |        0.75|0.52 [0.22-1.20]             |     77|       0.88|concordant   |
|c3_cgvhd     |  4|post_block9 |0.67 [0.39-1.14]         |        0.31|0.50 [0.19-1.30]             |     49|       0.68|concordant   |
|c3_nrm       |  5|post_block9 |0.96 [0.74-1.24]         |        1.11|0.49 [0.17-1.39]             |     80|       0.95|concordant   |
|c3_os        |  6|post_block9 |1.11 [0.95-1.30]         |        0.84|0.92 [0.57-1.49]             |     78|       0.45|concordant   |
|c3_rrm       |  6|post_block9 |0.80 [0.50-1.27]         |        0.31|0.75 [0.44-1.29]             |      7|       0.20|concordant   |
