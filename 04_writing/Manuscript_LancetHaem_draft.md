...
[NEEDS DECISION — per-comparison counts: the breakdown "C1: 83; C2: 42; C3: 13" predates Set B deduplication. Under Set B the number of distinct studies contributing at least one modelled outcome is C1: 73, C2: 27, C3: 13. The two quantities are not the same thing — "extractable event counts" is a superset of "actually entered a model", because the outcome-aware cohort rule drops same-cohort duplicates. Decide which quantity Figure 1 should report, and reconcile against the 117 total.]

**Figure 2: Forest plot — overall survival (Comparisons 1 and 2)**
Individual study odds ratios with 95% Wald CIs (raw per-study data) and pooled Bayesian random-effects posterior median with 95% credible interval (primary model M1) for overall survival. Panel A: C1, PTCy versus CNI+MTX/MMF (k=35, OR 0·84 [95% CrI 0·76–0·92]; τ=0·66). Panel B: C2, PTCy versus ATG (k=9, OR 0·83 [0·75–0·92]; τ=0·50). Estimates are Set B (cohort-deduplicated: one publication per cohort per outcome). Events and denominators per arm are tabulated in Table S4b. The corresponding frequentist (REML) concordance check is provided in Appendix Figure S8a-i.

**Figure 3: Forest plot — CMV reactivation (Comparisons 1 and 2)**
Individual study odds ratios for CMV any-reactivation. Panel A: C1 (k=22, OR 1·26 [1·07–1·47]; τ=0·73). Panel B: C2 (k=12, OR 0·97 [0·77–1·23]; τ=0·63). CMV reactivation is increased with PTCy relative to CNI+MTX/MMF but is null relative to ATG, consistent with a gradient in depth of T-cell depletion rather than a reversal of direction of effect. Pooled estimates are Bayesian random-effects posterior medians with 95% credible intervals (primary model M1), shown with the posterior density above the pooled row; estimates are Set B (cohort-deduplicated). The corresponding frequentist (REML) concordance check is provided in Appendix Figure S8a-ii.

**Figure 4: Forest plots — bacterial, fungal, and BK viral infection risk (Comparison 1)**
Individual study odds ratios (raw per-study estimates) and pooled Bayesian random-effects posterior median with 95% credible interval (primary model M1), shown with the posterior density above each pooled row. Panel A: bloodstream infection, any pathogen (k=6, OR 1·87 [1·33–2·62]). Panel B: invasive fungal infection, any (k=6, OR 0·43 [0·29–0·63]; τ=1·53, reflecting extreme heterogeneity, probably confounded by antifungal prophylaxis practice). Panel C: BK virus reactivation (k=11, OR 2·48 [1·82–3·38]; τ=1·00), the largest infection effect observed. All three comparisons are C1 (PTCy vs CNI+MTX/MMF); insufficient studies were available to fit the corresponding C2 models for BSI and IFI.

**Conventions common to Appendix Figures S8a–S8j**
In every panel, individual rows are raw per-study odds ratios computed directly from each study's 2×2 event table (95% Wald CIs; a 0·5 continuity correction is applied to zero cells only), ordered by effect size. The x-axis is on a log₁₀ scale and the dashed vertical line marks OR=1·0. Each panel subtitle gives the comparison, the number of paired studies (k), and the total number of patients summed across both arms (N); each panel caption gives I², τ, and the p value of the heterogeneity Q test. Rows labelled "RE Model" are pooled by frequentist random-effects meta-analysis (metafor, REML, inverse-variance weighted). Where a panel is described as Bayesian, the pooled row is instead the primary model (M1) posterior median and 95% credible interval, drawn as a diamond with the full posterior density of the pooled odds ratio rising above the pooled row. Because M1 specifies a single shared treatment effect with a study-level random intercept and no per-study random slope, individual studies have no posterior of their own and therefore carry no density. All estimates are Set B (cohort-deduplicated: one publication per cohort per outcome). Events and denominators per arm are tabulated in Table S4b rather than printed on the plots. OR<1 favours PTCy for survival, mortality, and GVHD outcomes; OR>1 indicates elevated risk with PTCy for infection outcomes.

**Appendix Figure S8a-i: Forest plot — overall survival, frequentist concordance check (Comparisons 1 and 2)**
Frequentist random-effects (REML) re-analysis of the overall survival data presented in Figure 2, provided as a concordance check on the primary Bayesian model. Panel A: C1, PTCy versus CNI+MTX/MMF (k=35, N=10 133; pooled OR 0·79 [95% CI 0·65–0·94]; I²=64%, τ=0·40). Panel B: C2, PTCy versus ATG (k=9, N=12 791; pooled OR 0·73 [0·44–1·21]; I²=93%, τ=0·67). The C1 estimate agrees with the Bayesian result in direction and in excluding unity. For C2 the REML interval crosses unity whereas the Bayesian M1 interval does not (0·83 [0·75–0·92]); this divergence is attributable to the very high between-study heterogeneity (I²=93%) combined with the normal-approximation likelihood and inverse-variance weighting of the REML fit, versus the exact binomial likelihood and partial pooling of M1. Interpretation should not rest on the C2 REML interval alone (Appendix S9e).

**Appendix Figure S8a-ii: Forest plot — CMV any reactivation, frequentist concordance check (Comparisons 1 and 2)**
Frequentist random-effects (REML) re-analysis of the CMV data presented in Figure 3. Panel A: C1 (k=22, N=3328; pooled OR 1·25 [95% CI 0·94–1·66]; I²=62%, τ=0·50). Panel B: C2 (k=12, N=1511; pooled OR 0·83 [0·51–1·33]; I²=69%, τ=0·66). The REML point estimate for C1 is close to the Bayesian estimate (1·26) but its interval crosses unity, so the frequentist analysis does not independently establish the C1 CMV signal; the discrepancy again reflects likelihood approximation and weighting rather than a different dataset (Appendix S9e). Panel B is null under both frameworks.

**Appendix Figure S8b: Forest plot — acute GVHD grade II–IV (Comparisons 1 and 2)**
Pooled by frequentist random-effects meta-analysis (REML). Panel A: C1 (k=28, N=4197; pooled OR 0·61 [95% CI 0·47–0·79]; I²=62%, τ=0·53). Panel B: C2 (k=8, N=1039; pooled OR 0·51 [0·28–0·94]; I²=74%, τ=0·73). PTCy reduced grade II–IV acute GVHD against both comparators, with substantial residual heterogeneity in each.

**Appendix Figure S8c: Forest plot — non-relapse mortality (Comparisons 1 and 2)**
Pooled by frequentist random-effects meta-analysis (REML). Panel A: C1 (k=12, N=1309; pooled OR 0·91 [95% CI 0·68–1·23]; I²=0%, τ<0·01). Panel B: C2 (k=3, N=186; pooled OR 0·63 [0·30–1·34]; I²=0%, τ=0). Both intervals include unity. Panel B rests on only three studies and 186 patients, below the pre-specified minimum for a reportable pooled estimate, and is therefore shown for completeness only and is not carried into Table 2 or the GRADE assessment; it should not be interpreted as evidence of a non-relapse mortality difference versus ATG.

**Appendix Figure S8d: Forest plot — relapse-related mortality (Comparisons 1 and 2)**
Pooled by frequentist random-effects meta-analysis (REML). Panel A: C1 (k=34, N=11 121; pooled OR 0·86 [95% CI 0·76–0·97]; I²=0%, τ=0). Panel B: C2 (k=10, N=17 182; pooled OR 0·78 [0·57–1·05]; I²=57%, τ=0·30). Relapse-related mortality was reduced with PTCy versus CNI+MTX/MMF; the C2 interval includes unity. The absence of detectable heterogeneity in Panel A is unusual for a corpus of this size and should be read alongside the risk-of-bias assessment (Appendix S5) rather than as evidence of a homogeneous underlying effect.

**Appendix Figure S8e: Forest plot — chronic GVHD, moderate–severe (Comparisons 1 and 2)**
Pooled by frequentist random-effects meta-analysis (REML). Panel A: C1 (k=19, N=2840; pooled OR 0·42 [95% CI 0·28–0·61]; I²=58%, τ=0·58). Panel B: C2 (k=6, N=905; pooled OR 0·77 [0·40–1·45]; I²=60%, τ=0·57). PTCy reduced moderate-to-severe chronic GVHD versus CNI+MTX/MMF; the comparison against ATG is null. The C1 analytic dataset for this outcome was rebuilt under the corrected outcome-aware cohort rule, which removed two studies ineligible under that rule; the resulting estimate is materially weaker than the value reported in earlier drafts (Appendix S12).

**Appendix Figure S8f: Forest plot — bloodstream infection, any pathogen (Comparison 1)**
Single-panel figure; the pooled row is the Bayesian M1 posterior (k=6, N=806; OR 1·87 [95% CrI 1·33–2·62]; τ=0·88), shown with the posterior density above the pooled row. Bloodstream infection was more frequent with PTCy. The frequentist REML re-analysis of the same six studies gives a substantially wider and null result (OR 1·29 [95% CI 0·61–2·73]; I²=71%); with only six studies and marked heterogeneity, the apparent precision of the Bayesian interval derives in part from partial pooling and the binomial likelihood, and the certainty of this outcome is correspondingly rated very low (Appendix S11).

**Appendix Figure S8g: Forest plot — invasive fungal infection, any (Comparison 1)**
Single-panel figure; the pooled row is the Bayesian M1 posterior (k=6, N=2243; OR 0·43 [95% CrI 0·29–0·63]; τ=1·53), shown with the posterior density above the pooled row. τ=1·53 is the largest between-study standard deviation of any model in the analysis, and the frequentist REML re-analysis of the same studies is null (OR 0·60 [95% CI 0·21–1·74]; I²=80%). Leave-one-out analysis identifies Haebe S 2023 as the dominant heterogeneity driver (Appendix Figure S9b). The apparent protective effect is likely confounded by differences in antifungal prophylaxis practice, which was not extractable across studies, and should not be interpreted causally.

**Appendix Figure S8h: Forest plot — BK virus reactivation (Comparisons 1 and 2)**
Pooled rows are Bayesian M1 posteriors, shown with the posterior density above each pooled row. Panel A: C1 (k=11, N=1333; OR 2·48 [95% CrI 1·82–3·38]; τ=1·00). Panel B: C2 (k=3, N=313; OR 2·44 [1·40–4·26]; τ=0·39). BK virus reactivation was the largest infection signal observed against either comparator. Panel B rests on only three studies and 313 patients, below the pre-specified minimum for a reportable pooled estimate, and is shown for completeness only. BK reactivation was not a pre-specified primary outcome and ascertainment was almost certainly non-systematic across studies, since screening for BK viruria and viraemia is not uniform practice.

**Appendix Figure S8i: Forest plot — infection-related mortality (Comparisons 1 and 2)**
Pooled by frequentist random-effects meta-analysis (REML). Panel A: C1 (k=13, N=5504; pooled OR 1·03 [95% CI 0·72–1·46]; I²=57%, τ=0·45). Panel B: C2 (k=7, N=13 346; pooled OR 0·93 [0·66–1·31]; I²=39%, τ=0·25). Both intervals include unity: despite the increases in CMV reactivation, bloodstream infection, and BK reactivation seen in Comparison 1, no corresponding increase in infection-related mortality was detected. The Bayesian C1 estimate (1·19 [1·00–1·43]) is marginal and its interval touches unity, so this outcome should be described as showing no clear difference rather than as showing an increase.

**Appendix Figure S8j: Forest plot — within-PTCy regimen variants, all outcomes (Comparison 3)**
Four-panel figure comparing regimen variants within PTCy-containing prophylaxis; all panels pooled by frequentist random-effects meta-analysis (REML). Panel A: overall survival (k=6, N=4746; pooled OR 0·92 [95% CI 0·57–1·49]; I²=78%, τ=0·45). Panel B: non-relapse mortality (k=5, N=2529; pooled OR 0·49 [0·17–1·39]; I²=80%, τ=0·95). Panel C: acute GVHD grade II–IV (k=7, N=2450; pooled OR 0·52 [0·22–1·20]; I²=77%, τ=0·88). Panel D: chronic GVHD (k=4, N=383; pooled OR 0·50 [0·19–1·30]; I²=49%, τ=0·68). Every interval includes unity, as do the corresponding Bayesian estimates, so no regimen variant was distinguishable from another on any outcome. Comparison 3 pools heterogeneous and non-equivalent contrasts (differing in cyclophosphamide dose, timing, and companion agents) with few studies per contrast and high heterogeneity throughout; these panels should be read as an absence of evidence rather than as evidence of equivalence.

**Appendix Figure S9a: CMV sensitivity analyses (Comparison 1)**
Point estimates and 95% CrIs for C1 CMV across three analyses: primary corpus (k=22, OR 1·26), post-2020 studies (k=17, OR 1·53), and haploidentical-dominant cohorts (k=12, OR 1·38). All estimates significantly exceed 1·0 (P(OR>1) ≥ 99·9% in all three subsets).
