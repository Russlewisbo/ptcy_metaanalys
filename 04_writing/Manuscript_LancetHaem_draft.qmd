...
post_cmv_primary  <- readRDS(file.path(model_dir, "post_c1_cmv.rds"))
...
```{r}
#| label: fig-forest-os
#| fig-cap: "Figure 2: Forest plots — overall survival"
#| fig-height: 14
...
#| fig-cap: "Figure 3: Forest plots — CMV any-reactivation"
#| fig-height: 12
...
p1 / p2 + plot_layout(heights = c(2.5, 1.5))
```

CMV reactivation was increased in C1 (k=22, OR 1·26 [1·07–1·47]; @fig-forest-cmv). This effect was steroid-independent (M2 OR 1·25 [1·01–1·54]) and strengthened in sensitivity analyses (@fig-cmv-sensitivity). BSI was elevated (k=6, OR 1·87 [1·33–2·62]) and BK virus reactivation showed the largest infection effect (k=11, OR 2·48 [1·82–3·38]). IFI was reduced (k=6, OR 0·43 [0·29–0·63]), though with extreme heterogeneity (τ=1·64). Infection-related mortality was modestly elevated (k=16, OR 1·35 [1·16–1·57]).

```{r}
#| label: fig-cmv-sensitivity
#| fig-cap: "Figure 4: CMV sensitivity analyses (Comparison 1). All three estimates use post-Block-9 data. Both subgroup restrictions strengthen the signal."
#| fig-height: 4
...
ggplot(sens_df, aes(x = or, y = model)) +
